...
from .utils import split_id, get_post_name_from_commentid, get_account_name, get_capaign_name_and_id
...
def social_auth_data(request):
    ...
    if social_user:
        ...
        friend_list_url = "https://graph.facebook.com/v15.0/{}/friends".format(social_user.uid)
